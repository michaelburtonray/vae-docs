...
Dashboard](/backstage.newsletter/) for that list.
...
tab](/backstage.newsletter/) or [All
Campaigns](/backstage.newsletter/) tab opens the List Dashboard
for that list:
...
[Campaigns](/backstage.newsletter/) and
[Subscribers](/backstage.newsletter/) tabs, respectively.
...
Dashboard](/backstage.newsletter/) opens the Subscribers tab. It
...
> Campaigns from the [List Dashboard](/backstage.newsletter/). When
...
3.  Design Template - The template to use for this campaign. To add or
    ...
    tab](/backstage.newsletter/). Changing this value will
